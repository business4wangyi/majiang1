...
export class RuleEngine {
   ...
   */
  static canGang(player: Player, tile: Tile | null = null): { canGang: boolean, gangType: GangType | null, tiles?: Tile[] } {
