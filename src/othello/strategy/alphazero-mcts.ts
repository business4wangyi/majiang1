...
import { AlphaZeroNetwork, AlphaZeroPrediction, IAlphaZeroNetwork } from './alphazero-network';
import { AlphaZeroAdvancedNetwork } from './alphazero-network-advanced';
...
class MCTSNode {
   ...
   * 扩展节点
   */
  expand(network: IAlphaZeroNetwork): void {
