...
import { DQNOthelloAgent, TRAINING_DQN_AGENT_CONFIG } from '../agents/dqn-agent';
import { ExperienceReplay, Experience, DEFAULT_EXPERIENCE_REPLAY_CONFIG } from '../utils/experience-replay';
...
import { OthelloAgent, RandomOthelloAgent } from '../agents/random-agent';
