...
import { AlphaZeroAgentConfig, DEFAULT_ALPHAZERO_AGENT_CONFIG } from '../agents/alphazero-agent';
import { DEFAULT_ALPHAZERO_CONFIG } from '../networks/alphazero-network';
import { DEFAULT_MCTS_CONFIG } from '../mcts/alphazero-mcts';
