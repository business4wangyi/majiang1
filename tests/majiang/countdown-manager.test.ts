...
import { errorLog } from '../../src/majiang/tools/logger';
import * as loggerModule from '../../src/majiang/tools/logger';
import * as displayManagerModule from '../../src/majiang/ui/display-manager';
