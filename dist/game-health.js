...
//     const expectedHandSize = player.getExpectedHandSize(player.state === PlayerState.ACTING);
//     if (!player.hasValidHandSize(player.state === PlayerState.ACTING)) {
//       warnLog(`玩家 ${player.name} 手牌数量异常: ${handSize}, 预期: ${expectedHandSize}`);
//       return false;
//     }
//   }
...
//     const expectedTiles = player.getExpectedHandSize(isCurrentPlayer && player.state === PlayerState.ACTING);
//     // 确保手牌一致性
